...
export class GameChatService implements OnDestroy {
    ...
    ngOnDestroy(): void {
        this.socketService.off(GameChatEvents.SendMessage);
        this.socketService.off(GameChatEvents.ReceiveMessage);
        this.accountDeletedSub?.unsubscribe();
    }

    private setupListeners() {
        this.socketService.on<MessagePayload>(GameChatEvents.ReceiveMessage, (data) => {
